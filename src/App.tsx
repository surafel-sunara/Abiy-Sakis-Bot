      ...
      <div className="w-full z-10 min-h-screen flex flex-col items-center text-white">
        ...
        <div className="fixed top-0 left-0 w-full px-4 pt-8 z-10 flex flex-col items-center text-white">
          <div className="w-full cursor-pointer">
            ...
            <p className="text-lg" style={{ fontWeight: 'bold' }}>ሳክስፎን መጫወት ለጤና ይጠቅማል! <Arrow size={18} className="ml-0 mb-1 inline-block" /></p>
            </div>
          </div>
          ...
          <div className="text-base mt-2 flex items-center">
            ...
            <span className="ml-1">ሳክስ <Arrow size={18} className="ml-0 mb-1 inline-block" /></span>
          </div>
        </div>
            ...
            <div className="w-1/3 flex items-center justify-start max-w-32">
              <div className="flex items-center justify-center">
                ...
                <div className="ml-2 text-left">
                  ...
                  <span className="text-white text-large opacity-75">/ 7000</span>
                </div>
              </div>
            </div>
